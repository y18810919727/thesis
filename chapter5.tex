...
在实验环节，本章使用3个系统辨识数据集(2个公共数据集和1个私有数据集)评估了所提出模型在解决长期开环预测问题时的性能。
...
% \subsection{ODE-RSSM建模非均匀采样的随机非确定性系统的精度分析}
...
% \subsection{ODE-RSSM建模随机非确定性系统优势探究}
